...
function SideBar() {
  ...
  return (
    <div 
      className="fixed overflow-auto bg-gray-200 h-screen w-1/6"
    >
      <div className="flex mt-5 mx-6">
        ...
        >F</p>
        <p className="ml-3 2xl:text-base xl:text-sm py-3 font-semibold text-green-tx overflow-hidden truncate">First Scrum Project</p> 
      </div>
      ...
      <div className="w-full absolute bottom-20">
        ...
        <div className="hover:text-green-tx cursor-pointer">
          <div className="mt-5 ml-6 mr-14">
            <p className="text-sm overflow-hidden truncate font-bold">Dang Nguyen's Workspace aaaaaaaaaaaaaa</p>
          </div>
          <div className="absolute right-6 bottom-0">
            <SettingsOutlinedIcon style={{ fontSize: "24px", color: "#008000", paddingTop: "3px" }}/>
          </div>
        </div>
      </div>
    </div>    
